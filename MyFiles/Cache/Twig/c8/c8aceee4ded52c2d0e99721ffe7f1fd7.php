...
class __TwigTemplate_5b836ceb3dae91d9509acf8c27802cb2 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"";
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["counter"] => $context["model"]) {
            ...
            // line 86
            if ((twig_get_attribute($this->env, $this->source, ($context["currentView"] ?? null), "selected", [], "any", false, false, false, 86) == twig_get_attribute($this->env, $this->source, $context["model"], "primaryColumnValue", [], "method", false, false, false, 86))) {
    ...
    ";
        // line 129
        echo "    ";
        if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["currentView"] ?? null), "getPagination", [], "method", false, false, false, 129)) > 0)) {
            // line 130
            echo "        ";
...
";
    ...
    {
        return new Source("", "Master/EditListView.html.twig", "/var/www/html/facturascripts/Dinamic/View/Master/EditListView.html.twig");
    }
}
