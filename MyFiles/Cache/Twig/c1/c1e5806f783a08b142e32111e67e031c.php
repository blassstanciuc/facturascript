...
class __TwigTemplate_829de0db74efc1b38eca73858cbba204 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"";
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["counter"] => $context["model"]) {
            ...
            // line 87
            if ((twig_get_attribute($this->env, $this->source, ($context["currentView"] ?? null), "selected", [], "any", false, false, false, 87) == twig_get_attribute($this->env, $this->source, $context["model"], "primaryColumnValue", [], "method", false, false, false, 87))) {
...
";
    ...
    {
        return new Source("", "Master/EditListViewInLine.html.twig", "/var/www/html/facturascripts/Dinamic/View/Master/EditListViewInLine.html.twig");
    }
}
