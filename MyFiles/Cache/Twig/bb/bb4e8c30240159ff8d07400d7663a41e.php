...
class __TwigTemplate_6ee7a543d508fccc55678cb8f573b6de extends Template
{
    private $source;
    private $macros = [];
...
<form id=\"";
    ...
    <div class=\"";
        ...
        echo "        <div class=\"table-responsive\">
            ";
        // line 127
        $context["tableClass"] = (((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "toolBox", [], "method", false, false, false, 127), "appSettings", [], "method", false, false, false, 127), "get", [0 => "default", 1 => "tablesize"], "method", false, false, false, 127) == "small")) ? ("table-sm") : (""));
        // line 128
        ...
        echo "\">
                ...
                <tr>
                    ";
        // line 131
        if (((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["currentView"] ?? null), "cursor", [], "any", false, false, false, 131)) > 0) && (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["currentView"] ?? null), "settings", [], "any", false, false, false, 131), "checkBoxes", [], "any", false, false, false, 131) || twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["currentView"] ?? null), "settings", [], "any", false, false, false, 131), "clickable", [], "any", false, false, false, 131)))) {
            // line 132
            ...
            ";
                ...
                if ( !twig_test_empty(($context["saveFilters"] ?? null))) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["pageFilter"]) {
                        ...
                        // line 278
                        echo "                ";
                        $context["filterDesc"] = (((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["pageFilter"], "description", [], "any", false, false, false, 278)) > 10)) ? ((twig_slice($this->env, twig_get_attribute($this->env, $this->source, $context["pageFilter"], "description", [], "any", false, false, false, 278), 0, 10) . "...")) : (twig_get_attribute($this->env, $this->source, $context["pageFilter"], "description", [], "any", false, false, false, 278)));
                        // line 279
                        echo "                ";
                        if ((twig_get_attribute($this->env, $this->source, $context["pageFilter"], "id", [], "any", false, false, false, 279) == twig_get_attribute($this->env, $this->source, ($context["currentView"] ?? null), "pageFilterKey", [], "any", false, false, false, 279))) {
                            // line 280
                            echo "                    <div class=\"btn-group\">
                        ";
                            // line 282
...
";
        ...
        try {
            ...
            <div class=\"dropdown-menu dropdown-menu-right\">
                ...
                foreach ($context['_seq'] as $context["key"] => $context["orderby"]) {
                    // line 419
                    echo "                    ";
                    $context["activeClass"] = (((twig_get_attribute($this->env, $this->source, ($context["currentView"] ?? null), "orderKey", [], "any", false, false, false, 419) == $context["key"])) ? (" active") : (""));
                    // line 420
                    echo "                    ";
                    $context["icon"] = (((twig_get_attribute($this->env, $this->source, $context["orderby"], "type", [], "any", false, false, false, 420) == "ASC")) ? ("fas fa-sort-amount-down-alt") : ("fas fa-sort-amount-down"));
                    // line 421
    ...
    {
        return new Source("", "Master/ListView.html.twig", "/var/www/html/facturascripts/Dinamic/View/Master/ListView.html.twig");
    }
}
