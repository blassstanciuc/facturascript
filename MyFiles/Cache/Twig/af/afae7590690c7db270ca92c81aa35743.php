...
class __TwigTemplate_e6fc82b07871ab96d57e223aa34162d9 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
            ...
            foreach ($context['_seq'] as $context["viewName"] => $context["view"]) {
                ...
                if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["view"], "settings", [], "any", false, false, false, 39), "active", [], "any", false, false, false, 39)) {
                    ...
                    echo "                                <li class=\"nav-item\">
                                    ";
                    // line 42
                    $context["active"] = (((($context["viewName"] == twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "active", [], "any", false, false, false, 42)) || ((twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "active", [], "any", false, false, false, 42) == ($context["firstViewName"] ?? null)) && (($context["contActiveTab"] ?? null) == 1)))) ? (" active") : (""));
                    // line 43
                    echo "                                    <a href=\"#";
                    ...
                    echo "</span>
                                        ";
                    // line 46
                    if ((twig_get_attribute($this->env, $this->source, $context["view"], "count", [], "any", false, false, false, 46) > 0)) {
                        // line 47
                        echo "                                            <span class=\"badge badge-secondary\">";
                        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "toolBox", [], "method", false, false, false, 47), "numbers", [], "method", false, false, false, 47), "format", [0 => twig_get_attribute($this->env, $this->source, $context["view"], "count", [], "any", false, false, false, 47), 1 => 0], "method", false, false, false, 47), "html", null, true);
                        echo "</span>
                                        ";
                    }
                    // line 49
        ...
        foreach ($context['_seq'] as $context["viewName"] => $context["view"]) {
            ...
            if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["view"], "settings", [], "any", false, false, false, 60), "active", [], "any", false, false, false, 60)) {
                ...
                // line 62
                echo "                    ";
                $context["active"] = (((($context["viewName"] == twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "active", [], "any", false, false, false, 62)) || ((twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "active", [], "any", false, false, false, 62) == ($context["firstViewName"] ?? null)) && (($context["contActiveTab"] ?? null) == 1)))) ? (" show active") : (""));
                // line 63
                ...
                echo "\" role=\"tabpanel\">
                        ";
                // line 64
                twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "setCurrentView", [0 => $context["viewName"]], "method", false, false, false, 64);
                // line 65
                echo "                        ";
...
";
    ...
    {
        return new Source("", "Master/PanelControllerBottom.html.twig", "/var/www/html/facturascripts/Dinamic/View/Master/PanelControllerBottom.html.twig");
    }
}
